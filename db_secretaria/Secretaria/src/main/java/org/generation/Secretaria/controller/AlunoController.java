...
public class AlunoController {
	...
	public ResponseEntity<List<Aluno>> GetByMatriculado (@PathVariable boolean matriculado)
	{
	return ResponseEntity.ok(repository.findAllByMatriculado(matriculado));
	}
	...
	public ResponseEntity<List<Aluno>> GetBySerie (@PathVariable String serie)
	{
	return ResponseEntity.ok(repository.findAllBySerieContainingIgnoreCase(serie));	
	}
	@PostMapping
